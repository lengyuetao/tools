...
public class ImageCodeUtils {
	 ...
	 private int width=100;//图片宽度
	     ...
	     * @throws IOException
	     */
	    public String writeBase64Image() throws WriterException, IOException{
	    ...
	    public static void main(String[] args) {
	        ImageCodeUtils vCode = new ImageCodeUtils(100,40,5,150);
	        try {
	            String path="C:\\Users\\DELL\\Desktop\\"+new Date().getTime()+".png";
	            System.out.println(vCode.getCode()+" >"+path);
	            vCode.write(path);
	            
	            System.out.println(vCode.writeBase64Image());
	        } catch (IOException e) {
	            e.printStackTrace();
